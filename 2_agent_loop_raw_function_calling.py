...
def get_product_price(product: str) -> float:
    """Lookup the price of the product in a catalog"""
...
def apply_discount(price: float, discount_tier: str) -> float:
    ...
    print(f" >> Executing apply discount(price={price}, discount_tier={discount_tier})")
    discount_percentage = {"bronze": 5, "silver": 12, "gold": 20 }
    discount = discount_percentage.get(discount_tier, 0)
    return round(price * (1-discount/100), 2)

# Difference - Without @tools, we must define the schema of the json for each function
...
tools_for_llm = [
    ...
    },
    {
            ...
            "function": {
                "name": "apply_discount",
                "description": "Apply the discount to the product based on the discount tier. Available tiers: gold, silver and bronze",
                "parameters": {
                    "type": "object",
                    "properties": {
...
def run_agent(question: str):
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "1. Never guess or asssume any product price. "
    ...
    for iteration in range(1, MAX_ITERATIONS +1):
        ...
        # Difference 5: ollama_chat() directly instead of llm_with_tools.invoke()
        ...
        # Difference 6: Attribute access (.function.name) instead of dict access
...
if __name__ == "__main__":
    ...
    print()
    result = run_agent("What is the price of a laptop after gold discount?")